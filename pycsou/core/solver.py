...
class PrimalDualSplitting(GenericIterativeAlgorithm):
    ...
    **Default values of the hyperparameters provided here always ensure convergence of the algorithm.**
    ...
    See Also
    --------
    :py:class:`~pycsou.core.solver.PDS`
    """
...
class AcceleratedProximalGradientDescent(GenericIterativeAlgorithm):
    ...
    **Remark 2:**  The convergence is guaranteed for step sizes :math:`\tau\leq 1/\beta`. Without acceleration, APGD can be seen
    ...
    .. plot::
       ...
       from pycsou.core.solver import APGD
    ...
    See Also
    --------
    :py:class:`~pycsou.core.solver.APGD`
    """
    ...
    def __init__(self, dim: int, F: Optional[DifferentiableMap] = None, G: Optional[ProximableFunctional] = None,
        ...
        super(APGD, self).__init__(objective_functional=objective_functional, init_iterand=init_iterand,
                                   max_iter=max_iter, min_iter=min_iter, accuracy_threshold=accuracy_threshold,
                                   verbose=verbose)
...
class ChambollePockSplitting(PrimalDualSplitting):
    ...
    **Default values of the hyperparameters provided here always ensure convergence of the algorithm.**
    ...
    See Also
    --------
    :py:class:`~pycsou.core.solver.PrimalDualSplitting`, :py:class:`~pycsou.core.solver.DouglasRachfordSplitting`
    """
...
class DouglasRachfordSplitting(PrimalDualSplitting):
    ...
    **Default values of the hyperparameters provided here always ensure convergence of the algorithm.**
    ...
    See Also
    --------
    :py:class:`~pycsou.core.solver.PrimalDualSplitting`, :py:class:`~pycsou.core.solver.ChambollePockSplitting`
    """
...
class ForwardBackwardSplitting(PrimalDualSplitting):
    ...
    **Default values of the hyperparameters provided here always ensure convergence of the algorithm.**
    ...
    See Also
    --------
    :py:class:`~pycsou.core.solver.AcceleratedProximalGradientDescent`
    """
