...
.. raw:: html
    Sed quiquia non numquam ut consectetur. Dolore dolore aliquam ut. Quisquam sed porro quisquam. Magnam amet etincidunt quisquam dolor numquam numquam. Magnam porro aliquam porro voluptatem. Ut tempora magnam eius ut ut dolorem. Quaerat quiquia magnam sed modi aliquam adipisci.

    Neque quaerat magnam etincidunt neque sed quisquam quiquia. Modi quisquam amet sed neque ut quaerat neque. Quiquia quisquam labore dolor. Modi est non magnam. Sed amet quiquia tempora labore velit non. Dolore magnam tempora est.

    Adipisci voluptatem aliquam porro quisquam porro dolor consectetur. Dolorem tempora dolor adipisci porro quiquia numquam. Etincidunt ipsum sit etincidunt quaerat neque tempora. Adipisci ut ut est voluptatem ipsum. Velit dolorem tempora dolorem neque ipsum.
...
.. raw:: html
    ...
    <p>
        <strong>Short description</strong>: Compressed Sensing for EEG reconstruction
    </p>
    ...
    <p>
        <strong>Source code</strong>: <a href="https://github.com/lbrooks/CSEEG" target="_blank">Go to the source code repository</a>
    </p>

    
    <p>
        <strong>Documentation</strong>: <a href="https://lbrooks.github.io/CSEEG/html/index" target="_blank">Go to plugin documentation</a>
    <p>
...
.. raw:: html
    ...
    <p>
        <strong>Author(s)</strong>: Leon Brooks
    </p>
    
    
    <p>
        <strong>Contact</strong>: <a href="mailto:leon.brooks@pyxu_user.org">leon.brooks@pyxu_user.org</a>
    </p>
