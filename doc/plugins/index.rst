...
.. raw:: html
    ...
    <p> You can contribute contribute and share new image processing tools based on Pyxu with the <a href="https://github.com/matthieumeo/cookiecutter-pycsou-plugin"><strong>Pyxu cookiecutter</strong></a>. The cookiecutter aids developers by providing a structured template of classes and functions for plugin creation. Developers can then seamlessly introduce new features in line with Pyxu's established principles and structure. Once you have uploaded your package to <a href="https://pypi.org/">PyPi</a>, you can register your plugin package in the Pyxu FAIR by submitting a pull request to the <a href=https://github.com/matthieumeo/pycsou/><strong>Pyxu repository</strong></a>. See the <a href=../examples/contribute.html>Contributing to Pyxu-FAIR</a> tutorial for more details.
    </p>
