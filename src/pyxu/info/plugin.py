...
def _load_entry_points(glob, group, names=None):
    ...
    Pyxu accepts contributions in the form of Pyxu-plugins, which can be developed by third-party contributors
    and are not necessarily tested or verified by the team of Pyxu core developers. While we strive to ensure the
    ...
    does not represent a problem in practice but a warning that an attempt at overloading a Pyxu base object might
